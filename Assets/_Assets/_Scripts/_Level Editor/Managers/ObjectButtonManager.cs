...
public class ObjectButtonManager : MonoBehaviour //Attached to each button
{
    ...
    {
        foreach (var objectController in FindObjectsOfType<ObjectButtonManager>()) // SetButtonDeselected other buttons
        {
